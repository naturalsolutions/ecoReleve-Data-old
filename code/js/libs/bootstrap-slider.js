...
(function( $ ) {
	...
	var Slider = function(element, options) {
		...
		if (parent.hasClass('slider') === true) {
			...
			this.picker = $('<div id="slider" class="slider">'+
	...
	Slider.prototype = {
		...
		layout: function(){
			...
			if (this.range) {
				var stDate = this.value[0];
				stDate = new Date(stDate * 1000);
	        	// convert date format
	        	stDate = stDate.defaultView('YYYY/MM/DD');

	        	var endDate = this.value[1];
	        	endDate = new Date(endDate * 1000);
	        	endDate = endDate.defaultView('YYYY/MM/DD');

				this.tooltipInner.text(
					this.formater(stDate) + ' : ' + this.formater(endDate)
				);
